                ...
                'items' => [
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['icon' => 'store', 'label' => 'Manajemen Tenant', 'page' => 'event-tenants', 'href' => '/event-registrations', 'description' => 'Kelola tenant UMKM yang mendaftar ke event.'],
                            ['icon' => 'grid-2x2', 'label' => 'Manajemen Slot', 'page' => 'event-slots', 'href' => '/event-slots', 'description' => 'Atur slot tenant dalam event.'],
                            ['icon' => 'scan-line', 'label' => 'Absensi Event', 'page' => 'attendance', 'href' => '/registration-attendances', 'description' => 'Pantau check-in dan kehadiran peserta.'],
                        ],
                    ],
