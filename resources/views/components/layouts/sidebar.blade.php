...
<aside id="sidebar" class="fixed left-0 top-0 h-full w-64 z-40 flex flex-col overflow-hidden border-r -translate-x-full lg:translate-x-0 transition-transform duration-300">
    <div class="flex items-center gap-3 px-4 h-16 border-b border-slate-800 shrink-0">
        <div class="sidebar-logo-icon w-10 h-10 flex items-center justify-center shrink-0">
    ...
    <div class="border-t border-slate-800 px-3 py-3 shrink-0">
        <div class="flex items-center gap-3 px-1">
            <div class="w-8 h-8 rounded-full bg-white/90 text-brand-red ring-1 ring-white/50 flex items-center justify-center font-bold text-sm shrink-0">
            ...
            <form method="POST" action="{{ route('logout') }}" class="sidebar-logo-text ml-auto shrink-0">
                @csrf
