<x-layouts.auth title="Pilih Role">
    ...
    <div class="relative z-10 w-full max-w-4xl fade-in">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('register.masyarakat') }}" class="group rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl hover:border-indigo-500 hover:bg-slate-800">
                <div class="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-600 text-white">
                ...
                <span class="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-indigo-300 group-hover:text-indigo-200">
                    Pilih role
                    <i data-lucide="arrow-right" class="h-4 w-4"></i>
                </span>
            </a>

            <a href="{{ route('register.event-organizer') }}" class="group rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl hover:border-blue-500 hover:bg-slate-800">
                <div class="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-blue-600 text-white">
            ...
            <a href="{{ route('register.tenant') }}" class="group rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl hover:border-orange-500 hover:bg-slate-800">
                <div class="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-orange-500 text-white">
                ...
                <span class="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-orange-300 group-hover:text-orange-200">
                    Pilih role
                    <i data-lucide="arrow-right" class="h-4 w-4"></i>
                </span>
            </a>
